            ...
            <div className="px-8 py-8">
              <form onSubmit={LoginHandle} className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <Link
                    to={"/register"}
                    className="block text-center text-sm text-gray-600 hover:text-[#f97a00] transition-colors duration-200 font-medium mb-2 underline"
                  >
                    Daftar admin di sini
                  </Link>
                  <Link
                    to={"/"}
                    className="block text-center text-sm text-gray-600 hover:text-[#f97a00] transition-colors duration-200 font-medium"
                  >
                    ← Kembali ke beranda
                  </Link>
                </div>
